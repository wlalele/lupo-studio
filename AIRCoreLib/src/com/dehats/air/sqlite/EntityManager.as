package com.dehats.air.sqlite
{
	...
	/*
	 * ORIGINAL CLASS BY Christophe Coenraets 
	 
	 	Usage:
		private var entityMgr:EntityManager = EntityManager.getInstance();	 	
		entityMgr.sqlConnection = new SQLConnection();
		entityMgr.sqlConnection.open(File.desktopDirectory.resolvePath("TestORM.db"));
				
		var collec:ArrayCollection = entityMgr.findAll(Contact);// GET
	...
	public class EntityManager extends EventDispatcher
	{
		...
		*/
		...
		private function typeObject(o:Object, c:Class):Object
		{
 		...
 		// Used for creating a table after an AS3 object
